...
int main() {
  //INT DECLARATIONS  
  int choice, playerHandValue, dealerHandValue, playerIndexPos, dealerIndexPos, exitFlag, i, newCard, wincon=0, funds=0, bet=0, playerCardIndex, dealerCardIndex, playAgain=1;
  char line[128];
  srand(time(0));
